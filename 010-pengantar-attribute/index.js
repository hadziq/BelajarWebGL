(function(global) {
    ...
    function render() {
        // Mendapatkan lokasi penyimpanan dari Attribute aPosition
        var aPosition = gl.getAttribLocation(program, 'aPosition');
        if (aPosition < 0) {
            console.log('Gagal mendapatkan lokasi penyimpanan Attribute aPosition');
            return;
        }

        // Melewatkan posisi verteks ke variabel Attribute tersebut di atas
