(function(global) {
    ...
    function render() {
        ...
        // Gambar segitiga
        // gl.drawArrays(gl.TRIANGLES, 0, n);       // n segitiga dihasilkan oleh 3n verteks
        // gl.drawArrays(gl.TRIANGLE_STRIP, 0, n);  // n segitiga dihasilkan oleh n+2 verteks, indeks berlanjut
        gl.drawArrays(gl.TRIANGLE_FAN, 0, n);       // n segitiga dihasilkan oleh n+2 verteks, indeks berpusat
    }
